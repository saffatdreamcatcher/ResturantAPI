    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "DobAddrerss", "Email", "EmailConfirmed", "ExistingImage", "Facebook", "FatherName", "FirstName", "GenderId", "GenderName", "Github", "Image", "Instagram", "Label", "LastName", "Linkedin", "LockoutEnabled", "LockoutEnd", "MiddleName", "MotherName", "NId", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "SpouseName", "Twitter", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("16639bb0-4a6e-4e5a-ad05-560d4025d8de"), 0, "c0546a67-12e3-413e-98d7-2e981f03aa95", "Karachi", "admin@mail.com", false, "", "fb41", "N/A", "System", 0, "Male", "gg41", "", "Insta41", "12121", "", "link41", false, null, "Admin", "N/A", 645322, "admin@mail.com", "admin@mail.com", "AQAAAAEAACcQAAAAEFTw0YzFmNSap0Oq8Tb4C2h1Jdvd1fMHL+pKDwaxcY+2Rg/i3jP0cAKJshnm6wy/fQ==", "01779866803", false, "KOFABGFNZCSAIOQ7VCPER53GEIMMBIFK", "N/A", "twit41", false, "admin@mail.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("1e483d73-6cfe-43f1-a317-5a97412228eb"), "Park Street", 0.0, "Manager", "haris@gmail.com", new DateTime(2024, 5, 6, 20, 18, 7, 962, DateTimeKind.Local).AddTicks(1375), "Haris", 3000m, new Guid("16639bb0-4a6e-4e5a-ad05-560d4025d8de") });

            migrationBuilder.InsertData(
                table: "EmployeeTables",
                columns: new[] { "Id", "EmployeeId", "TableId" },
                values: new object[] { 1, new Guid("1e483d73-6cfe-43f1-a317-5a97412228eb"), 1 });
